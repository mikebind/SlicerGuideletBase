...
class AirwayTrackerClass(object):
  ...
  def setupPanel(self, parentWidget):
    logging.debug('AirwayTrackerClass.setupPanel')
    collapsibleButton = ctk.ctkCollapsibleButton()

    collapsibleButton.setProperty('collapsedHeight', 20)
    collapsibleButton.text = "Path Tracking"
    ...
    pathTrackingLayout = qt.QVBoxLayout()
    pathTrackingLayout.setContentsMargins(12,4,4,4)
    pathTrackingLayout.setSpacing(4)
    ...
    pathTrackingLayout.addWidget(self.startStopRecordingButton)
    ...
    '''
    procedureLayout.addLayout(pathTrackingLayout)

    #return collapsibleButton, ultrasoundLayout, procedureLayout
    return collapsibleButton, pathTrackingLayout, procedureLayout

  def setupScene(self):
    logging.info("AirwayTrackerClass.setupScene")
